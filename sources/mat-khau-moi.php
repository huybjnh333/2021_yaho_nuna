...
<div class="link_title">
  <div class="pagewrap">
    <ul>
      <li><a href="<?=$full_url ?>"><i class="fa fa-home"></i><?=$glo_lang['trang_chu'] ?></a><span>/</span><a ><?=$glo_lang['thay_doi_mat_khau'] ?></a></li>
      <div class="clr"></div>
    </ul>
  </div>
</div>
...
<div class="right-text-ad left-text">
    <h2><?=$glo_lang['thay_doi_mat_khau'] ?></h2>
    <h6>
    </h6>
    <div>
        ...
        <form action="" method="post" name="dangnhap" id="dangnhap">
            ...
            <p><a class="cur" id="dangnhap" onClick="laymat_khau()"><?=$glo_lang['luu_thay_doi'] ?> <img class="img_load_from_dktv" src="images/loading2.gif"></a></p>
        </form>
    </div>
</div>
<div class="clr"></div>
