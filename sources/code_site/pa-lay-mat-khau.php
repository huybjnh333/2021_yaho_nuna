...
<form action="" method="post" name="dangnhap" id="dangnhap">
    ...
    <div class="ungtuyen_popup">
        ...
        <div class="col-md-4 row-frm">
            <p><?= $glo_lang['email'] ?></p>
            <input type="text" name="email_dk" id="email_dk" class="form-control" value="<?= $email ?>"
                   readonly='readonly'>
        </div>
        <div class="col-md-4 row-frm">
            <p><?= $glo_lang['login_pass'] ?> (*)</p>
            <input type="password" name="pass_dk" id="pass_dk" class="form-control" data-rong="1"
                   data-msso="<?= $glo_lang['login_nhap_mat_khau'] ?>">
        </div>
        <div class="col-md-4 row-frm">
            <p><?= $glo_lang['register_repass'] ?> (*)</p>
            <input type="password" name="repass_dk" id="repass_dk" class="form-control repass" id-khac="#pass_dk"
