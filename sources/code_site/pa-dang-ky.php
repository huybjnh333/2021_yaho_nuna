...
<form action="" method="post" name="dangkythanhvien" id="dangkythanhvien">
    <div class="ungtuyen_popup">
        ...
        <div class="col-md-4 row-frm">
            <input type="text" name="email_dk" class="form-control cls_data_check_form_check_dangky" data-rong="1"
        ...
        <div class="col-md-4 row-frm">
            <input type="password" name="pass_dk" class="form-control cls_data_check_form_check_dangky" id="pass_dk"
                   data-rong="1" data-msso="<?= $glo_lang['login_nhap_mat_khau'] ?>"
                   placeholder="<?= $glo_lang['login_pass'] ?> (*)">
        </div>
        <div class="col-md-4 row-frm">
            <input type="password" name="repass_dk" class="form-control cls_data_check_form_check_dangky" id="repass_dk"
        ...
        <div class="col-md-4 row-frm">
            <input type="text" name="fullname_dk" class="form-control cls_data_check_form_check_dangky" data-rong="1"
                   data-msso="<?= $glo_lang['nhap_ho_ten'] ?>" placeholder="<?= $glo_lang['ho_va_ten'] ?> (*)">
        </div>
        <div class="col-md-4 row-frm">
            <input type="text" id="phone_dk" class="form-control cls_data_check_form_check_dangky" name="phone_dk"
        ...
        <div class="col-md-4 row-frm">
            <input type="text" name="diachi" class="form-control cls_data_check_form_check_dangky" data-rong="1"
    ...
    <span class="span_mbv">
      <img src="<?= $full_url . "/load-capcha/" ?>" alt="CAPTCHA code"
           onclick="$(this).attr('src','<?= $full_url . "/load-capcha/" ?>')" id="img_contact_cap"><i
            ...
            <input class="form-control cls_data_check_form_check_dangky" data-rong="1" name="mabaove" id="mabaove"
        ...
        <div class="login_link">
            <ul>
                <h3 class="fb"><a href="<?= $full_url . "/?login=fb" ?>"><i
                                class="fa fa-facebook fa-fw"></i><?= $glo_lang['dang_ky_bang_facebook'] ?></a></h3>
                <h3 class="google"><a href="<?= $full_url . "/?login=google" ?>"><i
                                class="fa fa-google fa-fw"></i><?= $glo_lang['dang_ky_bang_google'] ?></a></h3>
            </ul>
        </div>
        <div class="clr"></div>
    </div>
