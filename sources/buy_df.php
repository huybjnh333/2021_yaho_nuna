...
<div class="link_pageload">
  <div class="pagewrap">
    <ul>
      <li><i class="fa fa-home"></i><a href="<?=$full_url ?>"><?=$glo_lang['trang_chu'] ?></a><span><i class="fa fa-angle-right"></i></span><a><?=$glo_lang['dat_hang'] ?></a></li>
      <div class="clr"></div>
    </ul>
  </div>
</div>
<div class="pagewrap page_conten_page">
  <div class="title_page_id"><?=$glo_lang['dat_hang'] ?></div>
                  ...
                  <div id="payment_method">
                    ...
                    <ul>
                      <li class="payment_method_input">
                        <label>
                          <input type="radio" value="1" name="type_payment" id="type1" <?=empty($_POST['type_payment']) || $_POST['type_payment'] == 1 ? 'checked="checked"' : '' ?> >
                      ...
                      <li class="payment_method_input">
                        <label>
                          <input type="radio" value="2" name="type_payment" id="type2" <?=!empty($_POST['type_payment']) && $_POST['type_payment'] == 2 ? 'checked="checked"' : '' ?>><span><?=$glo_lang['thanh_toan_chuyen_khoan'] ?></span>
                          <div class="clr"></div>
                        </label>
                      </li>
                      <li class="payment_method_input">
                        <label>
                          <input type="radio" value="3" name="type_payment" id="type3" <?=!empty($_POST['type_payment']) && $_POST['type_payment'] == 3 ? 'checked="checked"' : '' ?>><span><?=$glo_lang['thanh_toan_paypal'] ?></span>
                          <div class="clr"></div>
                        </label>
                      </li>
                    </ul>
