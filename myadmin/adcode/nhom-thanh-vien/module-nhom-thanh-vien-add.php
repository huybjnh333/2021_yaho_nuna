...
if ($id > 0) {
    ...
    $catasort = number_format((DB_num($catasort) + 1), 0, ',', '.');
}
?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phan_tram"
                                           value="<?= !empty($phan_tram) ? $phan_tram : 0 ?>">
                                </div>
                                <div class="form-group">
                                    <label>Số thứ tự</label>
                                    <input type="text" class="form-control" name="catasort"
                                           value="<?= !empty($catasort) ? $catasort : 1 ?>">
                                </div>
                                <div class="form-group">
                                    <label class="checkbox-mini">
                                        <input name='showhi' type='checkbox'
                                               class='minimal' <?= (!empty($showhi) && $showhi) == 1 || !isset($showhi) ? "checked='checked'" : "" ?>>
                                        Hiển thị
                                    </label>
                                </div>
                            </div>
