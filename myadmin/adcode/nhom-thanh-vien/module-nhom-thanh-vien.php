            ...
            <div class="row">
                <section class="col-lg-12">
                    <div class="box">
                        ...
                        $chietkhau = DB_arr($chietkhau, 1);
                        ?>
                        <div class="form-group" style="margin: 0 10px;">
                            <p style="font-size: 13px; font-weight: 600; margin: 0 0 7px;">Chiết khấu (%) cho thành viên
                                thường</p>
                            <input type="text" class="form-control" name="chiet_khau_def"
                                   value="<?= $chietkhau['chiet_khau_def'] ?>">
                        </div>
                                ...
                                foreach ($sql_array as $rows) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <input type="text" class="text-center" name="catasort<?= $cl ?>"
                                                   value="<?= $catasort ?>">
                                        </td>
                                        <td>
                                            <div class="name">
                                                <input type="text" name="tenbaiviet_vi<?= $cl ?>"
                                                       value="<?= $tenbaiviet_vi ?>">
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <input type="text" class="text-center" name="phan_tram<?= $cl ?>"
                                                   value="<?= $phan_tram ?>">
                                        </td>
                                        <td class="text-center">
