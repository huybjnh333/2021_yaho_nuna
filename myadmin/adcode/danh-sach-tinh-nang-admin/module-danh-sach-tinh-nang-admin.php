...
if (isset($_GET['them-moi']) || (isset($_GET['edit']) && is_numeric($_GET['edit']))) {
    ...
    if (isset($_POST['xoa_all_data']) && md5($_POST['name_matkhau']) == "b5a7e60d31d536e73f6c43fc084b1f3f") {
        ...
        DB_que("TRUNCATE `#_yeuthich`");
        DB_que("TRUNCATE `#_binhluan`");
        DB_que("TRUNCATE `#_baiviet_chitiet`");
        DB_que("TRUNCATE `#_baiviet_sao`");
        DB_que("TRUNCATE `#_baiviet_thuoctinh`");
        DB_que("TRUNCATE `#_thuoctinhchung`");
        DB_que("TRUNCATE `#_lien_ket_nhanh_phan_tram`");
        DB_que("TRUNCATE `#_members_nhom`");
        DB_que("TRUNCATE `#_subdomain`");
            ...
            <div class="row">
                <section class="col-lg-12">
                    <div class="box">
                        ...
                        <div class="box-header">
                            <h3 class="box-title box-title-td pull-right">
                                <input type="text" name="name_matkhau" value="" placeholder="Mật khẩu"
                                       style="border: 1px dotted rgb(199, 199, 199); outline: none; padding: 4px 5px; width: 200px; margin-bottom: 4px; font-size: 13px; height: 32px; border-radius: 4px;">
