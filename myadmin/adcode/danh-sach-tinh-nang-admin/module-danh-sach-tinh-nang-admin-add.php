                            ...
                            <div class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="m_action"
                                           value="<?= !empty($m_action) ? Show_text($m_action) : "" ?>">
                                </div>
                                <div class="form-group">
                                    <label>Icon</label>
                                ...
                                <div class="form-group">
                                    <label style="margin-right: 10px">
                                        <input name='m_xem' type='checkbox'
                                               class='minimal' <?= !empty($m_xem) && $m_xem == 1 ? 'checked="checked"' : '' ?> >
                                        Xem
                                    </label>
                                    <label style="margin-right: 10px">
                                        <input name='m_them' type='checkbox'
                                               class='minimal' <?= !empty($m_them) && $m_them == 1 ? 'checked="checked"' : '' ?> >
                                        Thêm
                                    </label>
                                    <label style="margin-right: 10px">
                                        <input name='m_sua' type='checkbox'
                                               class='minimal' <?= !empty($m_sua) && $m_sua == 1 ? 'checked="checked"' : '' ?> >
                                        Sửa
                                    </label>
                                    <label>
                                        <input name='m_xoa' type='checkbox'
                                               class='minimal' <?= !empty($m_xoa) && $m_xoa == 1 ? 'checked="checked"' : '' ?> >
                                        Xóa
                                    </label>
                                    <label>
                                        <input name='m_other' type='checkbox'
                                               class='minimal' <?= !empty($m_other) && $m_other == 1 ? 'checked="checked"' : '' ?> >
                                        Link Ẩn
                                    </label>
                                    <label>
                                        <input name='m_dev' type='checkbox'
                                               class='minimal' <?= !empty($m_dev) && $m_dev == 1 ? 'checked="checked"' : '' ?> >
                                        Dev
                                    </label>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="id_parent" id="id_parent" class="form-control">
                                        ...
                                        foreach ($sql_se as $value) {
                                            ...
                                            foreach ($sql_se as $value_2) {
                                                ...
                                                ?>
                                                <option value="<?= $value_2['id'] ?>" <?= LAY_selected(@$id_parent, $value_2['id']) ?>>
                                                    ╙─► <?= $value_2['ten_vi'] ?></option>
                                                <?php
                                                foreach ($sql_se as $value_3) {
                                                    if ($value_3['id_parent'] != $value_2['id']) continue;
                                                    ?>
                                                    <option value="<?= $value_3['id'] ?>" <?= LAY_selected(@$id_parent, $value_3['id']) ?>>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;╙─► <?= $value_3['ten_vi'] ?></option>
                                                <?php }
                                            }
                                        } ?>
                                    </select>
