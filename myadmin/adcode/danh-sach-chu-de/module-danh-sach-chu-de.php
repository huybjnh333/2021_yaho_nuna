...
if (isset($_GET['upload']) && (isset($_GET['edit']) && is_numeric($_GET['edit']))) {
            ...
            if (isset($_POST["xoa_gr_arr_$i"])) {
                ...
                if (DB_num($sql_se) > 0) {
                    ...
                    foreach ($sql_se_c1 as $row_1) {
                        ...
                        $sql_se_c2 = DB_arr($sql_se_c2);
                        foreach ($sql_se_c2 as $row_2) {
                            ...
                            $sql_se_c3 = DB_arr($sql_se_c3);
                            foreach ($sql_se_c3 as $row_3) {
                                ...
                                $sql_se_c4 = DB_arr($sql_se_c4);
                                foreach ($sql_se_c4 as $row_4) {
    ...
    <section class="content-header">
        <h1><?php if (isset($_SESSION['admin'])) { ?><a onclick="LOAD_sort()"
                                                        class="cur load_okkk">[SORT]</a> <?php } ?> <?= $name_title ?>
        </h1>
        <ol class="breadcrumb">
                        ...
                        <div class="box-body table-responsive no-padding table-danhsach-cont">
                            <table class="table table-hover table-danhsach">
                                ...
                                <tr>
                                    ...
                                    <?php } ?>
<!--                                    <th class="w150 text-center">Trang chủ</th>-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="name">
                                                ...
                                                <p class="p_lang_en"><?= $tenbaiviet_en ?>
                                                    <?php if($step == 11){ ?>
                                                    - Giới tính :
                                                    <?php
                                                    $gt = "Nam";
                                                    if($rows['gioitinh'] == 1) $gt = "Nữ";
                                                    else if($rows['gioitinh'] == 2) $gt = "Trung tính";
                                                    echo $gt;
                                                    }
                                                    ?></p>
                                            </div>
                                    ...
                                    foreach ($sql_array as $rows_1) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <input type="text" class="text-center" value="<?= $catasort_1 ?>"
                                                       onchange="UPDATE_colum(this, '<?= $ida_1 ?>', 'catasort','<?= $table ?> ')">
                                            </td>
                                            <td>
                                                <span class="sp-list-cap1">╚═►</span>
                                                <div class="name name_list_cap_1">
                                                    <a href="<?= $url_page ?>&step=<?= $step ?>&id_step=<?= $id_step ?>&edit=<?= $ida_1 ?>"
                                                       title="<?= luu_lai ?>"><?= $tenbaiviet_vi_1 ?></a>
                                            ...
                                            <?php if (in_array($step, $check_anh_dm)) { ?>
                                                <td class="text-center">
                                                    <img class='img_show_ds'
                                                         src='<?= $fullpath . "/" . $rows_1['duongdantin'] . "/thumb_" . $icon_1 ?>'>
                                                    <?php if (isset($_SESSION['admin'])) { ?>
                                                        <input type="file" name="upload_<?= $cl ?>">
                                                        <input type="hidden" name="anh_sp_<?= $cl ?>"
                                                               value="<?= !empty($thongtin_step['size_img_dm']) && $thongtin_step['size_img_dm'] != '' ? $thongtin_step['size_img_dm'] : '' ?>">
                                            ...
                                            <?php if (in_array($step, $check_dm_tb)) { ?>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input opt type='checkbox' class='minimal minimal_click'
                                                                      colum="opt" idcol="<?= $ida_1 ?>"
                                                                      table="<?= $table ?>"
                                                                      value='1' <?= LAY_checked($opt_1, 1) ?>></label>
                                                    </div>
                                                </td>
                                            <?php } ?>
                                            ...
                                            <!--<td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input opt type='checkbox' class='minimal minimal_click'
                                                                  colum="opt1" idcol="<?= $ida_1 ?>"
                                                                  table="<?= $table ?>"
                                                                  value='1' <?= LAY_checked($opt1_1, 1) ?>></label>
                                                </div>
                                            </td>-->
                                            ...
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input showhi type='checkbox' class='minimal minimal_click'
                                                                  colum="showhi" idcol="<?= $ida_1 ?>"
                                                                  table="<?= $table ?>"
                                                                  value='1' <?= LAY_checked($showhi_1, 1) ?>></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <input name='xoa_gr_arr_<?= $cl ?>' type='checkbox'
                                        ...
                                        foreach ($sql_array as $rows_2) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="name name_list_cap_2">
                                                        <a href="<?= $url_page ?>&step=<?= $step ?>&id_step=<?= $id_step ?>&edit=<?= $ida_2 ?>"
                                                           title="<?= luu_lai ?>"><?= $tenbaiviet_vi_2 ?></a>
                                                ...
                                                <?php if (in_array($step, $check_anh_dm)) { ?>
                                                    <td class="text-center">
                                                        <img class='img_show_ds'
                                                             src='<?= $fullpath . "/" . $rows_2['duongdantin'] . "/thumb_" . $icon_2 ?>'>
                                                        <?php if (isset($_SESSION['admin'])) { ?>
                                                            <input type="file" name="upload_<?= $cl ?>">
                                                            <input type="hidden" name="anh_sp_<?= $cl ?>"
                                                                   value="<?= !empty($thongtin_step['size_img_dm']) && $thongtin_step['size_img_dm'] != '' ? $thongtin_step['size_img_dm'] : '' ?>">
                                                ...
                                                <?php if (in_array($step, $check_dm_tb)) { ?>
                                                    <td class="text-center">
                                                        <div id="cus" class="cus_menu">
                                                            <label><input opt type='checkbox'
                                                                          class='minimal minimal_click' colum="opt"
                                                                          idcol="<?= $ida_2 ?>" table="<?= $table ?>"
                                            ...
                                            <!--<td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input opt type='checkbox'
                                                                      class='minimal minimal_click' colum="opt1"
                                                                      idcol="<?= $ida_2 ?>" table="<?= $table ?>"
                                                ...
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input showhi type='checkbox'
                                                                      class='minimal minimal_click' colum="showhi"
                                                                      idcol="<?= $ida_2 ?>" table="<?= $table ?>"
                                            ...
                                            foreach ($sql_array as $rows_3) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if (in_array($step, $check_anh_dm)) { ?>
                                                        <td class="text-center">
                                                            <img class='img_show_ds'
                                                                 src='<?= $fullpath . "/" . $rows_3['duongdantin'] . "/thumb_" . $icon_3 ?>'>
                                                            <?php if (isset($_SESSION['admin'])) { ?>
                                                                <input type="file" name="upload_<?= $cl ?>">
                                                                <input type="hidden" name="anh_sp_<?= $cl ?>"
                                                                       value="<?= !empty($thongtin_step['size_img_dm']) && $thongtin_step['size_img_dm'] != '' ? $thongtin_step['size_img_dm'] : '' ?>">
                                                        ...
                                                        <td class="text-center">
                                                            <div id="cus" class="cus_menu">
                                                                <label><input opt type='checkbox'
                                                                              ...
                                                                              idcol="<?= $ida_3 ?>"
                                                                              table="<?= $table ?>"
                                                                              value='1' <?= LAY_checked($opt_3, 1) ?>></label>
                                                            </div>
                                                        </td>
                                                    <?php } ?>
                                                    <td class="text-center">
                                                        <div id="cus" class="cus_menu">
                                                            <label><input showhi type='checkbox'
                                                                          class='minimal minimal_click' colum="showhi"
                                                                          idcol="<?= $ida_3 ?>" table="<?= $table ?>"
                                                                          value='1' <?= LAY_checked($showhi_3, 1) ?>></label>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <input name='xoa_gr_arr_<?= $cl ?>' type='checkbox'
