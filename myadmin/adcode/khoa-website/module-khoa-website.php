                                ...
                                <div class="form-group">
                                    <label class="mr-20">
                                        <input type="radio" name="showhi" class="minimal"
                                               value="1" <?= LAY_checked($showhi, 1) ?>> Khóa
                                    </label>
                                    <label>
                                        <input type="radio" name="showhi" class="minimal"
                                               value="0" <?= LAY_checked($showhi, 0) ?>> Mở
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label>Nội dung <a
                                                data-tooltip="Dù website bị ĐÓNG, nhưng nếu bạn đăng nhập bằng tài khoản admin, bạn vẫn thấy như bình thường."> </a></label>
                                    <textarea id="noidung_vi" class="paEditor" name="noidung_vi" rows="10"
