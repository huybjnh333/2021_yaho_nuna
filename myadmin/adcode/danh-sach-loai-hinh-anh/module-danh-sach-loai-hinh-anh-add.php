                    ...
                    <div class="box p10">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                   value="<?= ($id > 0) ? SHOW_text($tenbaiviet_vi) : '' ?>" name="tenbaiviet_vi"
                                   id="tenbaiviet_vi">
                        </div>

                        <div class="form-group">
                            <label>Rộng</label>
                            <input type="text" class="form-control" name="rong"
                                   value="<?= ($id > 0) ? SHOW_text($rong) : '' ?>">
                        </div>

                        <div class="form-group">
                            <label>Cao</label>
                            <input type="text" class="form-control" name="cao"
                                   value="<?= ($id > 0) ? SHOW_text($cao) : '' ?>">
                        </div>

                        <div class="form-group">
                            <label>Số thứ tự</label>
                            <input type="text" class="form-control" name="catasort" id="catasort"
                                   value="<?= SHOW_text($catasort) ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label>
                                <input type="radio" name="showhi" class="minimal"
                                       value="2" <?= ($id > 0) ? LAY_checked($showhi, 2) : '' ?>> Ẩn
                            </label>
                        </div>
                    </div>
                </div>
