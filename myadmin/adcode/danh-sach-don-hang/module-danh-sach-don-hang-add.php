                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img class='img_show_ds' src='<?=$anhsp ?>'>
                                    </td>
                                    <td>
                                        ...
                                        <p class="p_mota_cart">
                                          ...
                                          <?php 
                                            $isthuoctinh = @explode(",", $is_key[$i]);
                                            foreach ($isthuoctinh as $ittinh) { 
                                              if(@$tinhnang_arr[$ittinh]['tenbaiviet_vi'] == "") continue;
                                              echo '<span style="background: #ec8417; border-radius: 3px; padding: 2px 5px; margin: 2px 5px 2px 0; color: #fff; font-size: 12px;display: inline-block;">'.$tinhnang_arr[$ittinh]['tenbaiviet_vi'].'</span>';
                                            }
                                          ?>
                                        </p>
                                    </td>
