<?php
$table = '#_lien_ket_nhanh_phan_tram';
if (isset($_GET['them-moi']) || (isset($_GET['edit']) && is_numeric($_GET['edit']))) {
    include "module-thiet-lap-tim-kiem-phan-tram-add.php";
} else {
                ...
                <section class="col-lg-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h2 class="h2_title">
                                <i class="fa fa-pencil-square-o"></i> Thiết lập tìm kiếm theo %
                            </h2>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <input type="text" class="text-center" value="<?= $catasort ?>"
                                                   onchange="UPDATE_colum(this, '<?= $id ?>', 'catasort','<?= $table ?>')">
                                        </td>
                                        <td>
                                            <div class="name">
                                        ...
                                        <td class="text-center">
                                            <div id="cus" class="cus_menu">
                                                <label><input showhi type='checkbox' class='minimal minimal_click'
                                                              colum="showhi" idcol="<?= $id ?>" table="<?= $table ?>"
