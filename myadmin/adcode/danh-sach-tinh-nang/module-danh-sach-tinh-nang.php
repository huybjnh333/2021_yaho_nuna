                        ...
                        <div class="box-body table-responsive no-padding table-danhsach-cont">
                            <table class="table table-hover table-danhsach">
                                ...
                                <tr>
                                    ...
                                    <th>Tiêu đề</th>
                                    <th class="cls_tieubieu w100 text-center">Đặt hàng</th>
                                    <th class="cls_noibat w100 text-center">Hình ảnh</th>
                                    <?php if ($is_hinhanh) { ?>
                                    ...
                                    <?php } ?>
                                    <?php if (in_array($step, $st_nhom_opt_tn_1)) { ?>
                                        <th class="w90 text-center"><?= @$name_list_opti_tn[$step]["op0"] ?></th>
                                    <?php } ?>
                                    <?php if (in_array($step, $st_nhom_opt_tn_2)) { ?>
                                        <th class="w90 text-center"><?= @$name_list_opti_tn[$step]["op1"] ?></th>
                                    <?php } ?>
                                    <?php if (in_array($step, $st_nhom_opt_tn_3)) { ?>
                                        <th class="w90 text-center"><?= @$name_list_opti_tn[$step]["op2"] ?></th>
                                    <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center cls_tieubieu">
                                            <div id="cus" class="cus_menu">
                                                <label><input noi_bat type='checkbox' class='minimal minimal_click'
                                                              colum="noi_bat" idcol="<?= $ida ?>" table="<?= $table ?>"
                                                              value='1' <?= LAY_checked($noi_bat, 1) ?>></label>
                                            </div>
                                        </td>
                                        <td class="text-center cls_noibat">
                                            <div id="cus" class="cus_menu">
                                                <label><input tieu_bieu type='checkbox' class='minimal minimal_click'
                                                              colum="tieu_bieu" idcol="<?= $ida ?>"
                                                              table="<?= $table ?>"
                                                              value='1' <?= LAY_checked($tieu_bieu, 1) ?>></label>
                                            </div>
                                        </td>
                                        <?php if ($is_hinhanh) { ?>
                                            <td class="text-center">
                                        ...
                                        <?php if ($is_kieuchon) { ?>
                                            <td class="text-center ">
                                                <div id="cus" class="cus_menu">
                                                    <label><input loai_hienthi type='checkbox'
                                                                  class='minimal minimal_click' colum="loai_hienthi"
                                                                  idcol="<?= $ida ?>" table="<?= $table ?>"
                                                                  value='1' <?= LAY_checked($loai_hienthi, 1) ?>></label>
                                                </div>
                                            </td>
                                        <?php } ?>
                                        <?php if ($is_kieuhienthi) { ?>
                                            <td class="text-center cls_timkiem">
                                                <div id="cus" class="cus_menu">
                                                    <label><input tim_kiem type='checkbox' class='minimal minimal_click'
                                                                  colum="tim_kiem" idcol="<?= $ida ?>"
                                                                  table="<?= $table ?>"
                                                                  value='1' <?= LAY_checked($tim_kiem, 1) ?>></label>
                                                </div>
                                            </td>
                                        <?php } ?>
                                        <?php if (in_array($step, $st_nhom_opt_tn_1)) { ?>
                                        ...
                                        <?php if (in_array($step, $st_nhom_opt_tn_2)) { ?>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input opt1 type='checkbox' class='minimal minimal_click'
                                                                  colum="opt1" idcol="<?= $id ?>"
                                                                  table="#_baiviet_tinhnang"
                                        ...
                                        <?php if (in_array($step, $st_nhom_opt_tn_3)) { ?>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input opt2 type='checkbox' class='minimal minimal_click'
                                                                  colum="opt2" idcol="<?= $id ?>"
                                                                  table="#_baiviet_tinhnang"
                                        ...
                                        <?php if (isset($_SESSION['admin'])) { ?>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input khong_xoa type='checkbox'
                                                                  class='minimal minimal_click' colum="khong_xoa"
                                                                  idcol="<?= $ida ?>" table="<?= $table ?>"
                                                                  value='1' <?= LAY_checked($khong_xoa, 1) ?>></label>
                                                </div>
                                            </td>
                                        <?php } ?>
                                    ...
                                    foreach ($sql_array as $rows_2) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <input type="text" class="text-center" value="<?= $catasort_2 ?>"
                                                       onchange="UPDATE_colum(this, '<?= $ida_2 ?>', 'catasort','<?= $table ?> ')">
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="name name_list_cap_1">
                                                    <a href="<?= $url_page ?>&step=<?= $step ?>&id_step=<?= $id_step ?>&edit=<?= $ida_2 ?>"
                                                       title="Cập nhật"><?= $tenbaiviet_vi_2 ?></a>
                                ...
                                <label><input tieu_bieu type='checkbox' class='minimal minimal_click' colum="tieu_bieu" idcol="<?= $ida_2 ?>" table="<?= $table ?>" value='1' <?= LAY_checked($tieu_bieu_2, 1) ?>></label>
                                            ...
                                            <?php if ($is_hinhanh) { ?>
                                                <td class="text-center">
                                                    <img class='img_show_ds'
                                                         src='<?= $fullpath . "/" . $rows_2['duongdantin'] . "/thumb_" . $rows_2['icon'] ?>'>
                                                </td>
                                            <?php } ?>
                                            <?php if ($is_kieuchon) { ?>
                                                <td></td>
                                            ...
                                            <?php if (in_array($step, $st_nhom_opt_tn_1)) { ?>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input opt type='checkbox' class='minimal minimal_click'
                                                                      colum="opt" idcol="<?= $ida_2 ?>"
                                                                      table="#_baiviet_tinhnang"
                                                                      value='1' <?= LAY_checked($opt_2, 1) ?>></label>
                                                    </div>
                                                </td>
                                            <?php } ?>
                                            <?php if (in_array($step, $st_nhom_opt_tn_2)) { ?>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input opt1 type='checkbox' class='minimal minimal_click'
                                                                      colum="opt1" idcol="<?= $ida_2 ?>"
                                                                      table="#_baiviet_tinhnang"
                                                                      value='1' <?= LAY_checked($opt1_2, 1) ?>></label>
                                                    </div>
                                                </td>
                                            <?php } ?>
                                            <?php if (in_array($step, $st_nhom_opt_tn_3)) { ?>
                                                <td class="text-center">
                                                    <div id="cus" class="cus_menu">
                                                        <label><input opt2 type='checkbox' class='minimal minimal_click'
                                                                      colum="opt2" idcol="<?= $ida_2 ?>"
                                                                      table="#_baiviet_tinhnang"
                                                                      value='1' <?= LAY_checked($opt2_2, 1) ?>></label>
                                                    </div>
                                                </td>
                                            <?php } ?>
                                            <td class="text-center">
                                                <div id="cus" class="cus_menu">
                                                    <label><input showhi type='checkbox' class='minimal minimal_click'
                                                                  colum="showhi" idcol="<?= $ida_2 ?>"
                                                                  table="<?= $table ?>"
                                                                  value='1' <?= LAY_checked($showhi_2, 1) ?>></label>
                                                </div>
                                            </td>
                                            <?php if (isset($_SESSION['admin'])) { ?>
