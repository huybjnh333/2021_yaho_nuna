                    ...
                    <div class="nav-tabs-custom">
                        <div class="tab-content">
                            <div class="form-group">
                                <label>Mã ngôn ngữ <?php if ($_SESSION['admin']) { ?><a class="cur"
                                                                                        onclick="dich_td(this)">[NGÔN
                                        NGỮ]</a> <?php } ?></label>
                            ...
                            ?>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control js_lang_<?= $lang ?>" name="lang_<?= $lang ?>"
                                           value="<?= !empty(${"lang_".$lang}) ? ${"lang_".$lang} : '' ?>">
                                </div>
                            <?php } ?>
