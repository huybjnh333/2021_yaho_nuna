<?php
  ...
  if(isset($_GET['them-moi']) || (isset($_GET['edit']) && is_numeric($_GET['edit']))){
      include "module-bai-viet-goi-y-add.php";
  }else{
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title box-title-td pull-right">
                          ...
                          <a href="?module=main-module&action=danh-sach-bai-viet&step=<?=$step_id ?>&id_step=<?=$thongtin_step['step'] ?>" class="btn btn-primary"><i class="fa fa-sign-out"></i> Thoát</a>
                        </h3>
                        <h2 class="h2_title">
                      ...
                      <table class="table table-hover table-danhsach">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <?php } if($thongtin['bvct_file'] == 1){ ?>
                            <td class="text-center">
                              <a style="display: block; max-width: 400px; overflow: hidden; }" href="<?=$dowload_text ?>" target="_blank"><?=$rows['dowload_text'] ?></a>
                              <a style="display: block; max-width: 400px; overflow: hidden; }" href="<?=$fullpath."/datafiles/files/".$dowload ?>" download><?=$rows['dowload'] ?></a>
                            </td>
                            <?php } ?>
                            <td class="text-center">
