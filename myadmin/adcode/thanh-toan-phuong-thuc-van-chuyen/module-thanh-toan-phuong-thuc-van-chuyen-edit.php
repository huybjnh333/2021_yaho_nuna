            ...
            <section class="col-lg-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h2 class="h2_title">
                            <i class="fa fa-pencil-square-o"></i> <?= $id > 0 ? 'Sửa' : 'Thêm' ?> phí vận chuyển cho
                            <b><?= $kv == 0 ? 'các tỉnh/thành khác' : $khuvuc_arr[$kv]['tenbaiviet_vi'] ?></b>
                        </h2>
                        <h3 class="box-title box-title-td pull-right">
                            <button onclick="return checkSubmit()" type="submit" class="btn btn-primary"><i
                                        class="fa fa-floppy-o"></i> <?= luu_lai ?></button>
                            <a href="<?= $url_page ?>&kv=<?= $kv ?>" class="btn btn-primary"><i class="fa fa-plus"></i>
                                Thêm mới</a>
                    ...
                    <div class="nav-tabs-custom">
                            ...
                            foreach ($arr_lang as $rows) {
                                ...
                                <div class="tab-pane <?= $count_lang == 1 ? "active" : "" ?>"
                                    ...
                                    <div class="form-group">
                                        <label>Tên phương thức vận chuyển (<?= $lang ?>)</label>
                        ...
                        <div class="box p10">
                            <div class="form-group">
                                <label>Thời gian giao dự kiến <a
                                            data-tooltip="Các mức thời gian giao hàng dự kiến và được tính theo giờ, mỗi thời gian cách nhau bở dấu , Ví dụ: giao hàng khoản thời gian 24h và 48h nhập: 24, 48"> </a></label>
                                <input type="text" class="form-control" name="du_kien" id="catasort"
                                       value="<?= !empty($du_kien) ? $du_kien : "" ?>">
                            </div>
                        </div>
                        <div class="box p10">
                            <!-- <div class="form-group">
                ...
                <select name="loai" id="loai" class="form-control" onchange="if($(this).val() == 0) $('.sp_dvt').text('đ'); else $('.sp_dvt').text('Kg'); ">
                  ...
                  <option value="1" <?= LAY_selected(1, @$loai) ?>>Theo khối lượng sản phẩm</option>
                            ...
                            <div class="form-group">
                                <div>
                                    <label style=" width: 49.5%; float: left; position: relative;">
                                        <p>Tối thiểu</p>
                                        <input type="text" class="form-control"
                                               value="<?= !empty($toi_thieu) ? NUMBER_fomat($toi_thieu) : 0 ?>"
                                               name="toi_thieu" id="toi_thieu" onkeyup="SetCurrency(this)"><span
                                                class="sp_dvt"
                                                style="position: absolute; bottom: 6px; right: 10px; font-weight: 600; color: #656565;"><?= !empty($loai) && $loai == 1 ? "Kg" : "đ" ?></span>
                                    </label>
                                    <label style=" width: 49.5%; float: right; position: relative;">
                                        <p>Tối đa <span style="color: #a5a5a5;">(Nhập 0 mặc định trở lên)</span></p>
                                        <input type="text" class="form-control"
                                               value="<?= !empty($toi_da) ? NUMBER_fomat($toi_da) : 0 ?>" name="toi_da"
                                               id="toi_da" onkeyup="SetCurrency(this)"><span class="sp_dvt"
                                                                                             style="position: absolute; bottom: 6px; right: 10px; font-weight: 600; color: #656565;"><?= !empty($loai) && $loai == 1 ? "Kg" : "đ" ?></span>
                                    </label>
                                    <div class="clr"></div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="phi_van_chuyen" id="catasort"
                                       value="<?= !empty($phi_van_chuyen) ? NUMBER_fomat($phi_van_chuyen) : 0 ?>"
                                       onkeyup="SetCurrency(this)">
                            </div>
                            <?php if ($kv != 0) { ?>
                                <div class="dv-giadieu-chinh form-group">
                                    <p><b>Giá điều chỉnh</b> <span
                                                style="color: #ff0404;">(Giá cộng thêm vào giá gốc)</span></p>
                                    <div>
                                        <?php
                                        ...
                                        foreach ($khuvuc_arr as $value) {
                                            ...
                                            <label style="width: 230px; margin-right: 15px; margin-bottom: 10px; margin-top: 10px">
                                                ...
                                                <input type="text" name="gia_dieu_chinh[]"
                                                       value="<?= !empty($gia_dieu_chinh[$value['id']]) ? NUMBER_fomat($gia_dieu_chinh[$value['id']]) : 0 ?>"
                                                       class="form-control" onkeyup="SetCurrency(this)">
