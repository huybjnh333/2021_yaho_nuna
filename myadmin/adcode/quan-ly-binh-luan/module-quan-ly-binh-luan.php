                    ...
                    <div class="box-body table-responsive no-padding table-danhsach-cont">
                        <table class="table table-hover table-danhsach">
                            ...
                            <tr>
                                ...
                                <th>Tiêu đề</th>
                                <th class="w100 text-center">Số điện thoại</th>
                            ...
                            foreach ($sql as $rows) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div><a style="font-size: 12px; display: block;"
                                                ...
                                                target="_blank"><?= SHOW_text($sanpham['tenbaiviet_vi']) ?></a></div>
                                        <?php //if($uid != 0){ ?>
                                ...
                                <a style="display: block; font-size: 10px; color: #fb1919;" href="?module=quan-ly-thanh-vien&action=danh-sach-thanh-vien&edit=<?= $uid ?>" target='_blank'><?= @$member[$uid]['hoten'] ?> - <?= @$member[$uid]['email'] ?></a>
                                        ...
                                        <?php //} ?>
                                        <p><a style="cursor: pointer; font-size: 12px; color: #4CAF50;"
                                              onclick="show_binhtluan('<?= $ida ?>')">Xem bình luận</a></p>
                                        <div class="hide_url hide_url<?= $ida ?>"
                                             style="color: #585858; font-size: 12px;"><?= $noidung_vi ?></div>
                                    </td>
