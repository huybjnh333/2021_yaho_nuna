                            ...
                            <div class="box-tools">
                                ...
                                <div class="input-group input-group-sm input-group-sm-timkiem">
                                    <input name="ksearch" type="text" value="<?= $ksearch ?>"
                                           class="form-control pull-right key_search"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= $url_page ?>&edit=<?= $ida ?>"
                                               title="Cập nhật"><?= $email ?></a>
                                            <p>
                                                <?php if ($id_facebook != 0) { ?>
                                                    <a href="https://fb.com/<?= $id_facebook ?>" target="_blank"
                                                       style="width: 20px; height: 20px; background: #3c8dbc; text-align: center; color: #fff; border-radius: 100px; line-height: 20px; margin-top: 7px;"><i
                                                                class="fa fa-facebook" aria-hidden="true"
                                                                style="font-size: 12px;"></i></a>
                                                <?php }
                                                if ($id_google != 0) { ?>
                                                    <a href="https://plus.google.com/<?= $id_google ?>" target="_blank"
                                                       style="width: 20px; height: 20px; background: #e81a1a; text-align: center; color: #fff; border-radius: 100px; line-height: 20px; margin-top: 7px;"><i
                                        ...
                                        <td>
                                            <img class='img_show_ds'
                                                 src='<?= $fullpath . "/datafiles/member/" . $icon ?>'>
                                            <p style="margin: 0;">
                                                <?php if ($id_google != 0) { ?>
                                                    <a style="font-size: 10px; color: #888;" target="_blank"
                                                       href="<?= $google_icon ?>">
                                                        <img src="<?= $google_icon ?>" alt=""
                                                             style="height: 25px; width: 25px; border-radius: 100px; margin: 2px 3px 0 0;">
                                                        Google ID: <?= $id_google ?></a>
                                                <?php } ?>
                                                <?php if ($id_facebook != 0) { ?>
                                                    <a style="font-size: 10px; color: #888;" target="_blank"
                                                       href="<?= $facebook_icon ?>">
