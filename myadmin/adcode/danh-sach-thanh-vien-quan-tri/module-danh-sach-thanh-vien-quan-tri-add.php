...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $phanquyen = isset($_REQUEST['phanquyen']) ? $_REQUEST['phanquyen'] : 1;
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title box-title-td pull-right">
                            <button onclick="return RETURN_checkSubmit()" type="submit" class="btn btn-primary"><i
                    ...
                    <div class="box p10">
                        <?php if (count(GET_danhsachquyen()) > 1) { ?>
                            <div class="form-group">
                                ...
                                <select name="phanquyen" class="form-control">
                                    ...
                                    foreach (GET_danhsachquyen() as $val) {
                                        ?>
                                        <option <?= (isset($phanquyen)) ? LAY_selected($phanquyen, $val['id']) : '' ?>
                                                value="<?= $val['id'] ?>"><?= $val['ten_vi'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="tentruycap" name="tentruycap"
                                   value="<?= !empty($tentruycap) ? $tentruycap : '' ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="hoten" name="hoten"
                                   value="<?= !empty($hoten) ? $hoten : '' ?>">
                        </div>

                        <div class="form-group">
                            <label>Số điện thoại</label>
                            <input type="text" class="form-control" id="sodienthoai" name="sodienthoai"
                                   value="<?= !empty($sodienthoai) ? $sodienthoai : '' ?>">
                        </div>

                        <div class="form-group">
                            <label>Email (*)</label>
                            <input type="text" class="form-control" id="email_ad" name="email"
                                   value="<?= !empty($email) ? $email : '' ?>">
                        </div>
                        <div class="form-group">
                            <label>Địa chỉ</label>
                            <input type="text" class="form-control" id="diachi" name="diachi"
                                   value="<?= !empty($diachi) ? $diachi : '' ?>">
                        </div>
