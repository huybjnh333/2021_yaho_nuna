...
<nav class="navbar navbar-static-top">
  ...
  <div class="navbar-custom-menu">
    <ul class="nav navbar-nav">
      ...
      <li style="position: relative; top: 13px; display: none">
        <a style="padding: 0; float: left; display: inline-block; margin-right: 8px;" href="index.php?lang=vi"><img src="images/vn.png" alt="" style="height: 20px;"></a>
        <a style="padding: 0; float: left; display: inline-block; margin-right: 8px;" href="index.php?lang=en"><img src="images/eng.png" alt="" style="height: 20px;"></a>
      </li>
    </ul>
  </div>
</nav>
