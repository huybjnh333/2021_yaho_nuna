                    ...
                    <div class="box p10">
                        ...
                        <div class="form-group">
                            ...
                            <select name='type' class="form-control">
                                ...
                                <option value="2" <?= (isset($type)) ? LAY_selected(2, $type) : "" ?>>Email tư vấn & báo giá</option>
                                <!--<?php
                                    $danhsach_define2 = DB_fet_rd("*", "`#_clanguage`");
                                    $glo_lang        = array();
                                    foreach ($danhsach_define2 as $rows) {
                                    ...
                                    foreach ($chi_nhanh as $key => $val){
                                        $key = (int) $key + 2;
                                ?>
                                <option value="<?=$key?>" <?= (isset($type)) ? LAY_selected($key, $type) : "" ?>>Email <?=$val?></option>
                                <?php } ?>-->
