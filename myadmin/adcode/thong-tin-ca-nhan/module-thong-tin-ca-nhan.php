...
<form id="form_submit" name="form_submit" action="" method="post">
                ...
                <select name="phanquyen" class="form-control" disabled>
                  ...
                  <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input readonly type="text" class="form-control" id="tentruycap" name="tentruycap"
                                   value="<?= (isset($tentruycap)) ? $tentruycap : '' ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="mr-20">
                                <input type="radio" name="gioitinh" class="minimal"
                                       value="0" <?= (isset($_GET['edit'])) ? LAY_checked($gioitinh, 0) : 'checked' ?>>
                                Nam
                            </label>
                            <label>
                                <input type="radio" name="gioitinh" class="minimal"
                                       value="1" <?= (isset($_GET['edit'])) ? LAY_checked($gioitinh, 1) : '' ?>> Nữ
                            </label>
                        </div>
                    </div>
                </div>
    ...
    <div class="box-header mb-60">
        <h3 class="box-title box-title-td pull-right">
            <button onclick="return checkSubmit()" type="submit" name="capnhat" class="btn btn-primary"><i
