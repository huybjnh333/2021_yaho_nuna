                    ...
                    <div class="nav-tabs-custom">
                        <div class="tab-content">
                            <div class="tab-pane active">
                                ...
                                <div class="form-group">
                                    <label>Key</label>
                                    <input type="text" class="form-control" name="ten_key"
                                           value="<?= !empty($ten_key) ? Show_text($ten_key) : "" ?>">
                                </div>
                                ...
                                <div class="form-group">
                                    <label>
                                        <input name='is_check' type='checkbox'
                                               class='minimal' <?= (!empty($is_check) && $is_check) == 1 || empty($is_check) ? "checked='checked'" : "" ?>>
                                        Check
                                    </label>
                                </div>
                            </div>
