                            ...
                            <table class="table table-hover table-danhsach">
                                ...
                                foreach ($sql_array as $rows) {
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td><?= $seo_name ?></td> -->
                                        <td class="text-center">
                                            <a href="<?= $fullpath . "/" . $duongdantin . "/" . $icon ?>"
                                               target="_blank"><img class='img_show_ds'
                                                                    src='<?= $fullpath . "/" . $duongdantin . "/thumb_" . $icon ?>'></a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img class='img_show_ds'
                                                     src='<?= $fullpath . "/" . $duongdantin_2 . "/thumb_" . $icon_2 ?>'>
                                                <?php if (isset($_SESSION['admin'])) { ?>
                                                    <input type="file" name="upload_<?= $cl ?>">
                                                <?php } ?>
                                            </td>
