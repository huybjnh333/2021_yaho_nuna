                ...
                <div class="box">
                    ...
                    <div class="nav-tabs-custom">
                        <div class="tab-content">
                            <div class="tab-pane active">
                                <div class="form-group">
                                    <table class="table table-hover table-danhsach table-danhsach-pq"
                                                ...
                                                <td class="text-center">
                                                    <?php if ($m_xem == 1) { ?>
                                                        <input type="checkbox" class='minimal'
                                                               name="m_xem<?= $id ?>" <?= (($xem == 1) ? "checked='checked'" : "") ?> >
                                                    <?php } ?>
                                                </td>
                                                <td class="text-center">
                                                    <?php if ($m_them == 1) { ?>
                                                        <input type="checkbox" class='minimal'
                                                               name="m_them<?= $id ?>" <?= (($them == 1) ? "checked='checked'" : "") ?> >
                                                    <?php } ?>
                                                </td>
                                                <td class="text-center">
                                                    <?php if ($m_sua == 1) { ?>
                                                        <input type="checkbox" class='minimal'
                                                               name="m_sua<?= $id ?>" <?= (($sua == 1) ? "checked='checked'" : "") ?> >
                                                    <?php } ?>
                                                </td>
                                                <td class="text-center">
                                                    <?php if ($m_xoa == 1) { ?>
                                                        <input type="checkbox" class='minimal'
                                                               name="m_xoa<?= $id ?>" <?= (($xoa == 1) ? "checked='checked'" : "") ?> >
                                                    <?php } ?>
                                                </td>
                                                <td class="text-center">
                                                    <input type="checkbox" class='minimal'
                                                           name="m_menu<?= $id ?>" <?= (($menu == 1) ? "checked='checked'" : "") ?> >
                                                </td>
                                                ...
                                                foreach (LEFT_mainmenu_new() as $val) {
                                                    ...
                                                    <tr <?= $val['id'] ?>>
                                                        ...
                                                        <td class="w100 text-center">
                                                            <input type="checkbox" class='minimal'
                                                                   name="m_xem<?= $val['id'] ?>" <?= (($xem == 1) ? "checked='checked'" : "") ?> >
                                                        </td>
                                                        <td class="w100 text-center">
                                                            <input type="checkbox" class='minimal'
                                                                   name="m_them<?= $val['id'] ?>" <?= (($them == 1) ? "checked='checked'" : "") ?> >
                                                        </td>
                                                        <td class="w100 text-center">
                                                            <input type="checkbox" class='minimal'
                                                                   name="m_sua<?= $val['id'] ?>" <?= (($sua == 1) ? "checked='checked'" : "") ?> >
                                                        </td>
                                                        <td class="w100 text-center">
                                                            <input type="checkbox" class='minimal'
                                                                   name="m_xoa<?= $val['id'] ?>" <?= (($xoa == 1) ? "checked='checked'" : "") ?> >
                                                        </td>
                                                        <td class="w100 text-center">
                                                            <input type="checkbox" class='minimal'
                                                                   name="m_menu<?= $val['id'] ?>" <?= (($menu == 1) ? "checked='checked'" : "") ?> >
                                                        </td>
                                                    </tr>
                                                <?php }
                                            } ?>
