                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title box-title-td pull-right">
                            <button type="submit" class="btn btn-primary"><i class="fa fa-floppy-o"></i> <?= luu_lai ?>
                            </button>
                    ...
                    <div class="nav-tabs-custom">
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <div class="form-group">
                                    <label>Cột Mã SP <a
                                                data-tooltip="Quan trọng! Mã sản phẩm được so sánh từ CSDL và file excel để cập nhật giá"> </a></label>
                                    <input type="text" class="form-control"
                                           value="<?= !empty($ma_sp) ? SHOW_text($ma_sp) : '' ?>" name="ma_sp"
                                           id="ma_sp">
                                </div>
                                <div class="form-group">
                                    <label>Cột Tên sản phẩm <a
                                                data-tooltip="Giới hạn 50 cột trong excel, tính đến cột AX"> </a></label>
                                    <input type="text" class="form-control"
                                           value="<?= !empty($ten_sp) ? SHOW_text($ten_sp) : '' ?>" name="ten_sp"
                                           id="ten_sp">
                                </div>
                                <div class="form-group">
                                    <label>Cột Giá mặc định</label>
                                    <input type="text" class="form-control"
                                           value="<?= !empty($gia_md) ? SHOW_text($gia_md) : '' ?>" name="gia_md"
                                           id="gia_md">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           value="<?= !empty($gia_km) ? SHOW_text($gia_km) : '' ?>" name="gia_km"
                                           id="gia_km">
                                </div>
                                <div class="form-group">
                                    <label>Cột Bật Giá KM <a
                                                data-tooltip="Trạng thái trên file excel là Y (có) N (không)"> </a></label>
                                    <input type="text" class="form-control"
                                           value="<?= !empty($bat_gia_km) ? SHOW_text($bat_gia_km) : '' ?>"
                                           name="bat_gia_km" id="bat_gia_km">
                                </div>

                                <div class="form-group">
                                    <label>Ghi chú</label>
                                    <textarea id="noidung_vi" name="noidung_vi" class="form-control" rows="10"
