    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            ...
            <div class="form-group">
                ...
                <textarea id="mota_vi" name="mota_vi" class="paEditor" rows="10"
                          cols="50"><?= !empty($mota_vi) ? SHOW_text($mota_vi) : '' ?></textarea>
            </div>

            <div class="form-group">
                <label>Nội dung </label>
                <textarea id="noidung_vi" name="noidung_vi" class="paEditor" rows="10"
        ...
        <?php if ($lang_nb2) { ?>
            <div class="tab-pane" id="tab_2">
                ...
                <div class="form-group">
                    ...
                    <textarea id="mota_en" name="mota_en" class="paEditor" rows="10"
                              cols="50"><?= !empty($mota_en) ? SHOW_text($mota_en) : '' ?></textarea>
                </div>

                <div class="form-group">
                    <label>Nội dung (<?= _lang_nb2_key ?>)</label>
                    <textarea id="noidung_en" name="noidung_en" class="paEditor" rows="10"
