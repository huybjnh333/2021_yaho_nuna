...
<div class="box p10">
    ...
    <div class="form-group">
        <label class="mr-20 checkbox-mini">
            <input type="checkbox" name="opt_km" id="opt_km"
                   class="minimal" <?= isset($opt_km) && $opt_km == 0 ? '' : 'checked="checked"' ?>> Hiển thị ảnh
        </label>
    </div>

    <div class="form-group">
        <label>Tọa độ
            <a data-tooltip="Tọa độ sẽ được nhập theo dạng vĩ độ, kinh độ"> </a>
        </label>
        <input type="text" class="form-control " name="p3"
               id="p3"
               value="<?= !empty($p3) ? SHOW_text($p3) : '' ?>">
    </div>
