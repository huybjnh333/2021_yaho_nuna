        ...
        <div class="box">
          <div class="box-header with-border">
              ...
              <h3 class="box-title box-title-td pull-right">
                ...
                <?php } ?>
                <a href="<?=$url_page ?>" class="btn btn-primary"><i class="fa fa-sign-out"></i> <?=glo_lang_admin('Thoát') ?></a>
              </h3>
          </div>
          <div class="nav-tabs-custom">
            <div class="tab-content">
              <div class="form-group">
                <label><?=glo_lang_admin('Mã ngôn ngữ') ?> <?php if($_SESSION['admin']){ ?><a class="cur" onclick="dich_td(this)">[NGÔN NGỮ]</a> <?php } ?></label>
