                        ...
                        <div class="box-body table-responsive no-padding table-danhsach-cont">
                            <table class="table table-hover table-danhsach">
                                ...
                                <tr>
                                    ...
                                    <?php if (isset($_SESSION['admin'])) { ?>
                                        <th><?= glo_lang_admin('Mã ngôn ngữ') ?></th>
                                    <?php } ?>
                                    <th><?= glo_lang_admin('Ngôn ngữ') ?> (<?= _lang_nb1_key ?>)</th>
                                    <?php if ($lang_nb2) { ?>
                                        <th><?= glo_lang_admin('Ngôn ngữ') ?> (<?= _lang_nb2_key ?>)</th>
                                    <?php } ?>
                                    <?php if ($lang_nb3) { ?>
                                        <th><?= glo_lang_admin('Ngôn ngữ') ?> (<?= _lang_nb3_key ?>)</th>
                                    <?php } ?>
                                    <?php if ($lang_nb4) { ?>
                                        <th><?= glo_lang_admin('Ngôn ngữ') ?> (<?= _lang_nb4_key ?>)</th>
                                    <?php } ?>
                                    <?php if (isset($_SESSION['admin'])) { ?>
                                        <th class="w90 text-center">Hiển thị</th>
                                        <th class="w90 text-center">Nhóm</th>
                                    <?php } ?>
                                    <th class="w100 text-center"><?= glo_lang_admin('Tác vụ') ?></th>
                                </tr>
                                <?php
                                        ...
                                        <td>
                                            <div class="name">
                                                <input type="text" name="ncata_vi<?= $cl ?>"
                                                       value="<?= $text_lang_vi ?>"
                                                       onchange="UPDATE_colum(this, '<?= $ida ?>', 'lang_vi','<?= $table ?>')">
                                            </div>
                                        </td>
                                        <?php if ($lang_nb2) { ?>
                                            <td class="tienganh">
                                                <div class="name">
                                                    <input type="text" name="ncata_en<?= $cl ?>"
                                                           value="<?= $text_lang_en ?>"
                                                           onchange="UPDATE_colum(this, '<?= $ida ?>', 'lang_en','<?= $table ?>')">
                                                </div>
                                            </td>
                                        <?php } ?>
                                        <?php if ($lang_nb3) { ?>
                                            <td class="tienganh">
                                                <div class="name">
                                                    <input type="text" name="ncata_cn<?= $cl ?>"
                                                           value="<?= $text_lang_cn ?>"
                                                           onchange="UPDATE_colum(this, '<?= $ida ?>', 'lang_cn','<?= $table ?>')">
                                                </div>
                                            </td>
                                        <?php } ?>
                                        <?php if ($lang_nb4) { ?>
                                            <td class="tienganh">
                                                <div class="name">
                                                    <input type="text" name="ncata_jp<?= $cl ?>"
                                                           value="<?= $text_lang_jp ?>"
                                                           onchange="UPDATE_colum(this, '<?= $ida ?>', 'lang_jp','<?= $table ?>')">
                                                </div>
                                            </td>
                                        <?php } ?>
                                        <?php if (isset($_SESSION['admin'])) { ?>
