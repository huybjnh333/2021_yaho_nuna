                        ...
                        <div class="box_tab">
                            <ul class="listtabs">
                                <?php foreach ($id_parent_muti as $tn) { ?>
                                    <li><a href="<?= $full_url . "/$motty/?tn=" . $tn ?>"
                                           class="<?= isset($_GET['tn']) && $_GET['tn'] == $tn ? "selected" : "" ?> "><?= SHOW_text($bvtinhnang[$tn]['tenbaiviet_' . $lang]) ?></a>
                                    </li>
                                <?php } ?>
                                <div class="clr"></div>
                            </ul>
                            ...
                            while ($rows = mysqli_fetch_assoc($nd_kietxuat)) {
                                ...
                                <ul>
                                    ...
                                    <div class="view_more_pro">
                                        <div class="clolum_id"><a class="cur p_yeuthich p_yeuthich_<?= $rows['id'] ?>"
                                                                  onclick="ADD_yeuthich(this, <?= $rows['id'] ?>)"
                                                                  data="0"><i class="fa fa-heart-o"></i></a></div>
                                        <div class="clolum_id"><a <?= full_href($rows) ?>><i class="fa fa-eye"></i></a>
                                        </div>
                                        <div class="clolum_id"><a
                                                    href="<?= $full_url . "/gio-hang/?id=" . $rows['id'] ?>"><i
                ...
                <div class="menu_left">
                    ...
                    <ul>
                        ...
                        foreach ($qr_danhm as $rows) {
                            ?>
                            <li><a <?= full_href($rows) ?>><i
                                            class="fa fa-angle-double-right"></i><?= SHOW_text($rows['tenbaiviet_' . $lang]) ?>
                                </a></li>
                        <?php } ?>
                    </ul>
                </div>
